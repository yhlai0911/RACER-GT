...
continuous lognormal noise \emph{before} taking the window maximum and so never
returns identical integers: zero degenerate edges in 520 simulated, against 5 in
26 real ones. Version 1.4.0 therefore adds
...
joins, $5\%$ needs 574, and $10\%$ needs 2{,}189.
