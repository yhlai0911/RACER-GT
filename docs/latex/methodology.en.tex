...
Policy-uncertainty indices from news counts & no & to a base & likely & yes & yes\\
...
the baseline period. Whether their published history in fact moves when a corpus
is updated is not established here. It is testable by exactly the procedure this
paper describes --- retrieve the same historical span on different dates and
compare --- and that test does not require access to any restricted interface.
